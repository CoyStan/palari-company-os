...
EOF
./bin/palari --workspace "$agent_smoke_dir" mcp serve --repo . >$verify_output_dir/palari-company-mcp-lifecycle.jsonl <<'EOF'
{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2025-06-18"}}
{"jsonrpc":"2.0","method":"notifications/initialized"}
{"jsonrpc":"2.0","id":2,"method":"tools/call","params":{"name":"palari_agent_start","arguments":{"work_id":"WORK-0003","palari_id":"PALARI-SOFIA","mode":"execute","lease_minutes":5}}}
{"jsonrpc":"2.0","id":3,"method":"tools/call","params":{"name":"palari_agent_release","arguments":{"work_id":"WORK-0003","palari_id":"PALARI-SOFIA"}}}
{"jsonrpc":"2.0","id":4,"method":"tools/call","params":{"name":"palari_agent_finish","arguments":{"work_id":"WORK-0007","palari_id":"PALARI-SOFIA","mode":"execute"}}}
EOF
...
grep -q '"status":"claimed"' $verify_output_dir/palari-company-mcp-lifecycle.jsonl
grep -q '"status":"released"' $verify_output_dir/palari-company-mcp-lifecycle.jsonl
grep -q '"schema_version":"palari.agent_finish.v1"' $verify_output_dir/palari-company-mcp-lifecycle.jsonl
