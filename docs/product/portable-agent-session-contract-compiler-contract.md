...
- [x] **Outcome:** Preserve the approved five-stage blueprint execution
  ...
  **Status:** completed.
  **Exact committed proof:** `00c35be401bbcdcf82dcf7b81ecbc6bbd1a62aff`.

- [x] **Outcome:** Compile a deterministic provider-neutral session contract
...
- [x] **Outcome:** Expose the portable contract through one justified existing
...
- [x] **Outcome:** Detect missing, malformed, tampered, or authority-stale
  ...
  **Status:** completed; the first exact-head review found and the repair closes
  a missing-field downgrade from new claims into legacy compatibility.
  **Exact committed proof:** `00c35be401bbcdcf82dcf7b81ecbc6bbd1a62aff`.

- [x] **Outcome:** Report enforcement honestly so a portable declaration is
...
- [x] **Outcome:** Preserve package minimality, existing workspace/schema and
...
- [x] **Outcome:** Publish operator and agent documentation that explains the
...
- [ ] **Outcome:** Prove the exact committed candidate through focused tests,
  ...
  **Status:** in progress. Exact head
  ...
  repair is committed at `00c35be401bbcdcf82dcf7b81ecbc6bbd1a62aff`;
  its focused 191-test gate, Ruff, mypy, style, docs, and workspace validation
  pass. Exact-head complete/install verification and fresh review remain.
